...
class LevelEditor
{
  ...
  savePreset = () =>
  {
    ...
    const filename = "ccree_level_editor_preset.json";
  ...
  getViewData = () =>
  {
    ...
    const levelAreaScroll = le.getUIAreaScroll(levelKey, enemyGroupKey);
    return {
      componentData, levelKey, enemyGroupKey, enemyGroupList,
      showGroupField, showLevelEditArea, showEnemyFields,
      showDelayField, showTriggerField, levelAreaImage,
      levelAreaScroll, positionXRange, enemyId, enemy,
